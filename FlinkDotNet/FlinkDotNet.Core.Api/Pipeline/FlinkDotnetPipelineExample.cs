...
public class FlinkDotnetPipelineExample
{
    public static async Task RunExample()
    {
        ...
        logger.LogInformation("Starting Flink.Net Pipeline Example with comprehensive back pressure");
    ...
    private static async Task ExecutePipeline(
        ...
        ILogger logger)
    {
        logger.LogInformation("Executing Flink.Net pipeline with back pressure monitoring");
...
public class SimpleRuntimeContext : IRuntimeContext
{
    ...
    {
        JobName = "Flink.Net Pipeline Example";
        TaskName = taskName;
