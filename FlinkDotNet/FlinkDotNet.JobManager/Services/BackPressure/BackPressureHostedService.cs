...
/// when the JobManager application starts, following Flink.Net patterns.
/// </summary>
public class BackPressureHostedService : IHostedService
{
    ...
    {
        _logger.LogInformation("BackPressureHostedService starting - initializing Flink.Net style back pressure coordination");
