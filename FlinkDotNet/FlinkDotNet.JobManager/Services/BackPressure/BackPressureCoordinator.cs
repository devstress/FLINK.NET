...
/// <summary>
/// FlinkDotnet 2.0 style back pressure coordinator that monitors system pressure
...
public class BackPressureCoordinator : IDisposable
{
        ...
        ILoggerFactory? loggerFactory = null)
    {
        ...
        // FlinkDotnet 2.0 style monitoring every 5 seconds
    ...
    /// <summary>
    /// Calculates back pressure level using FlinkDotnet 2.0 heuristics including flow control
    /// </summary>
