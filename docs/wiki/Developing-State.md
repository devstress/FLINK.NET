...
- [Available State Primitives](#available-state-primitives)
- [Using State in Rich Functions](#using-state-in-rich-functions)
  - [1. Define a State Descriptor](#1-define-a-state-descriptor)
  - [2. Retrieve State in `Open()`](#2-retrieve-state-in-open)
  - [3. Using State Primitives](#3-using-state-primitives)
    - [`IValueState<T>`](#ivaluestatet)
    - [`IListState<T>`](#iliststatet)
    - [`IMapState<TK, TV>`](#imapstatetk-tv)
- [State Serialization](#state-serialization)
- [State Fault Tolerance (Checkpointing)](#state-fault-tolerance-checkpointing)
- [State Time-To-Live (TTL) - Planned](#state-time-to-live-ttl---planned)
...
---
**Navigation**
*   Previous: [Using IRuntimeContext](./Developing-RuntimeContext.md)
*   Next: [Windowing API (Future)](./Developing-Windowing-Api.md)
