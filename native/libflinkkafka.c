...
static void delivery_report_cb(rd_kafka_t *rk, const rd_kafka_message_t *rkmessage, void *opaque) {
    (void)rk; (void)opaque; // Suppress unused parameter warnings
...
static void error_cb(rd_kafka_t *rk, int err, const char *reason, void *opaque) {
    (void)rk; (void)err; (void)opaque; // Suppress unused parameter warnings
...
int flink_kafka_producer_flush(flink_kafka_producer_t* producer, int timeout_ms) {
    ...
    rd_kafka_resp_err_t result = rd_kafka_flush(producer->rk, timeout_ms);
